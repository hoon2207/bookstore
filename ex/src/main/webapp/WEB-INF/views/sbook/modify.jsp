    ...
    <script>
    	$(document).ready(function() {
			...
			$(".btn-danger").on("click", function() {
				self.location = "/sbook/booklist?page=${cri.page}&perPageNum=${cri.perPageNum}"
					...
					<form role="form" action="modify" method="post">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<input type="text" name='title' class="form-control" value="${bookVO.title}">
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">저자</label> 
								<input type="text" name="author" class="form-control" value="${bookVO.author}">
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">출판사</label> 
								<input type="text" name="publisher" class="form-control" value="${bookVO.publisher}">
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">출판일</label>&nbsp;&nbsp;<label>ex)2018년 08월</label>
								<input type="text" name="pubday" class="form-control" value="${bookVO.publisher}">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">책내용</label>
								<textarea name="content" class="form-control" rows="10">${bookVO.content}</textarea>
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">책 가격</label>&nbsp;&nbsp;<label style="color:red">필수 ex)10000</label> 
								<input type="text" name="price" class="form-control" value="${bookVO.price}">
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">책 수량</label>&nbsp;&nbsp;<label style="color:red">필수 ex)2</label> 
								<input type="text" name="quantity" class="form-control" value="${bookVO.quantity}">
							</div>
							<div class="form-group">
